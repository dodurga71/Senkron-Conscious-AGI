from data_pipelines.etl.transformers import pii_mask, mask_email, reliability_tagging

def test_pii_mask_basic():
    rec = {"email": "alice@example.com", "phone": "+90 555 123 45 67", "headline": "Haber başlığı"}
